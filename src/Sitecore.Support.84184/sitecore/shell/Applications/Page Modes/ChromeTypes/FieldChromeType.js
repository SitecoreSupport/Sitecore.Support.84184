Sitecore.PageModes.ChromeTypes.Field = Sitecore.PageModes.ChromeTypes.ChromeType.extend({
    ...
    onKeyUp: function (event) {
        ...
        if (this.chrome.element.attr("scfieldtype") == "rich text"
            ...
            && event.currentTarget.innerText != null && event.currentTarget.innerText.trim() == "" && $sc.removeTags(event.currentTarget.innerHTML) == "") {
    ...
    _tryUpdateFromWatermark: function () {
        if (this.watermarkHTML &&
            ...
            (this.chrome.element.html() == "" || (this.fieldType == "text" || this.fieldType == "rich text") && $sc.removeTags(this.chrome.element.html()) == "") && this.fieldValue[0].defaultValue == "") {
